...
ZCASHD=${ZCASHD:-$SRCDIR/asofed}
ZCASHCLI=${ZCASHCLI:-$SRCDIR/asofe-cli}
ZCASHTX=${ZCASHTX:-$SRCDIR/asofe-tx}
...
# This gets autodetected fine for asofed if --version-string is not set,
