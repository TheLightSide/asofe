...
For all methods, you will need to include an export directory setting in your config file (`asofe.conf` located in the data directory which is `~/.asofe/` unless it's been overridden with `datadir=` setting):
