...
General Asofe questions and/or support requests and are best directed to the [Zcash Forums](https://forum.z.cash) or [Community Rocket.Chat](https://chat.zcashcommunity.com).
...
This includes the relevant contents of `~/.asofe/debug.log`. You can paste raw text, attach the file directly in the issue or link to the text via a pastebin type site.
Please also include any non-standard things you did during compilation (extra flags, dependency version changes etc.) if applicable.

### Do you have a back up of `~/.asofe` directory and/or take a VM snapshot?
- Backing up / making a copy of the `~/.asofe` directory might help make the problem reproducible. Please redact appropriately.
