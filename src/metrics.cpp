...
int printMiningStatus(bool mining)
{
    ...
    if (mining) {
        ...
        std::cout << _("To enable mining, add 'gen=1' to your asofe.conf and restart.") << std::endl;
        lines += 2;
    }
    std::cout << std::endl;
...
void ThreadShowMetricsScreen()
{
    ...
    if (isScreen) {
        ...
        // Thank you text
        std::cout << strprintf(_("Thank you for running a %s Asofe node!"), WhichNetwork()) << std::endl;
    ...
    while (true) {
        ...
        if (isScreen) {
            ...
            std::cout << "[";
#ifdef WIN32
            std::cout << _("'asofe-cli.exe stop' to exit");
#else
